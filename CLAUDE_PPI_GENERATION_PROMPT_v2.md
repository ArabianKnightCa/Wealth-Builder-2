...
4. ☐ Maintaining **stealth assessment design** (questions feel like financial conversations, not psych tests)?
5. ☐ Creating exactly **270 questions** (30 in L1, 40 each in L2-L7)?
6. ☐ Ensuring all **24 VIA traits** are measured multiple times across layers?
7. ☐ Using **~60% Likert / ~40% MCQ** distribution per layer?
8. ☐ Options formatted as `"A text"`, `"B text"`, `"C text"`, `"D text"` (letter + space + text)?
